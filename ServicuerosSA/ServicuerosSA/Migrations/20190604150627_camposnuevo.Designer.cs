...
namespace ServicuerosSA.Migrations
{
    ...
    [Migration("20190604150627_camposnuevo")]
    partial class camposnuevo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicuerosSA.Models.Calibracion", b =>
                {
                    b.Property<int>("CalibracionId")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("CantidadA");

                    b.Property<int>("CantidadB");
            ...
            modelBuilder.Entity("ServicuerosSA.Models.ClasificacionWB", b =>
                {
                    ...
                    b.HasIndex("EscurridoId");

                    b.HasIndex("PersonalId");

                    b.HasIndex("clasiwebId");
            ...
            modelBuilder.Entity("ServicuerosSA.Models.Escurrido", b =>
                {
                    ...
                    b.Property<string>("codiuniescurridio");

                    b.HasKey("EscurridoId");

                    b.HasIndex("BomboId");

                    b.HasIndex("CurtidoId");
            ...
            modelBuilder.Entity("ServicuerosSA.Models.Medido", b =>
                {
                    b.Property<int>("MedidoId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("tipoweb");

                    b.HasKey("MedidoId");

                    b.HasIndex("BodegaId");

                    b.HasIndex("CalibracionId");
            ...
            modelBuilder.Entity("ServicuerosSA.Models.ClasificacionWB", b =>
                {
                    ...
                    b.HasOne("ServicuerosSA.Models.Escurrido", "escurrido")
                        .WithMany()
                        .HasForeignKey("EscurridoId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("ServicuerosSA.Models.Clasiweb", "clasiweb")
                        .WithMany()
                        .HasForeignKey("clasiwebId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("ServicuerosSA.Models.Escurrido", b =>
                {
                    ...
                    b.HasOne("ServicuerosSA.Models.Curtido", "Curtido")
                        .WithMany()
                        .HasForeignKey("CurtidoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ServicuerosSA.Models.Medido", b =>
                {
                    ...
                    b.HasOne("ServicuerosSA.Models.Calibracion", "Calibracion")
                        .WithMany()
                        .HasForeignKey("CalibracionId")
                        .OnDelete(DeleteBehavior.Restrict);
